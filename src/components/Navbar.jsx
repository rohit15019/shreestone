...
import { Sun, Moon, Menu, X, Sparkles, ShoppingBag, Download } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            {/* Catalog Download Button (Like Add to Cart) */}
            <button
              onClick={openModal}
              title="Download 2026 Tile Catalog & Price Guide"
              aria-label="Download Catalog"
              className="relative px-3 py-2.5 rounded-full bg-gray-100 dark:bg-charcoal-800 text-charcoal-800 dark:text-gold hover:bg-gold/10 hover:text-gold transition-colors border border-gray-200 dark:border-charcoal-700 flex items-center gap-1.5 font-medium text-xs shadow-sm"
            >
              <Download className="w-4 h-4 text-gold" />
              <span className="hidden lg:inline">Catalog</span>
            </button>

            {/* Showroom Cart Button */}
            <button
              onClick={openCart}
          ...
          <div className="flex md:hidden items-center gap-2">
            <button
              onClick={openModal}
              aria-label="Download Catalog"
              className="p-2 rounded-lg bg-gray-100 dark:bg-charcoal-800 text-charcoal-800 dark:text-gold border border-gray-200 dark:border-charcoal-700"
            >
              <Download className="w-4 h-4 text-gold" />
            </button>
            <button
          ...
          >
            ...
            <div className="pt-4 border-t border-gray-200 dark:border-charcoal-800 space-y-3">
              <button
                ...
                className="w-full py-2.5 rounded-lg bg-gray-100 dark:bg-charcoal-800 text-charcoal-900 dark:text-gold font-semibold text-sm border border-gray-200 dark:border-charcoal-700 flex items-center justify-center gap-2"
              >
                <Download className="w-4 h-4 text-gold" />
                <span>Download 2026 Tile Catalog (PDF/Spec)</span>
              </button>
